...
def get_system_stats(
    ...
    """
    user_count = crud.user.count_active(db)  # cheap proxy for "total users"
    # TODO: Add more stats as needed (chat count, message count, etc.)
    return {
        "total_users": user_count,
        "admin_users": crud.user.count_admins(db),
